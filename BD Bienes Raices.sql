...
CREATE DATABASE IF NOT EXISTS `bienesraices` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bienesraices`;

-- Volcando estructura para tabla bienesraices.propiedades
CREATE TABLE IF NOT EXISTS `propiedades` (
  `id` int NOT NULL AUTO_INCREMENT,
  `titulo` varchar(45) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0',
  `precio` decimal(10,2) NOT NULL DEFAULT (0),
  `imagen` varchar(200) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0',
